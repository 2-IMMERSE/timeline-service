...
def genTitlecards(pattern, heading, width, height, bgColor, fgColor, fontSize, firstTime, lastTime, interval):
...
def genTitlecardsElement(prefix, pattern, heading, width, height, bgColor, fgColor, fontSize, firstTime, lastTime, interval):
    ...
    for i in range(count):
        ...
        attrs = {
            ...
            timeline.NS_2IMMERSE("class") : "title-card",
            timeline.NS_2IMMERSE("url") : "https://origin.2immerse.advdev.tv/dmapp-components/title-card/title-card.html",
            timeline.NS_2IMMERSE_COMPONENT("posterUrl") : fileName,
            timeline.NS_2IMMERSE_COMPONENT(tc)
            }
